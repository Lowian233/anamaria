...
export default function Home() {
  ...
  const images = [
    "/images/landing.jpeg",
    "/images/landing2.jpeg",
    "/images/landing3.jpeg",
    "/images/landing4.jpeg",
    "/images/landing5.jpeg",
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-indigo-950">
      <main className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen">
        <div className="text-center space-y-8 max-w-3xl">
          ...
          <div className="relative w-64 h-64 mx-auto mb-8 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
            <Image
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400">
              ...
              <span>Muy pronto estaremos en línea</span>
            </div>
          </div>
